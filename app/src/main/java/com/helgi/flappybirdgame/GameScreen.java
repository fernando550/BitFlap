...
public class GameScreen extends Screen {
    ...
    // Stillum �etta svona svo �a� s� fyrst kalla� � updateReady a�fer�ina
    ...
    public GameScreen(Game game) {
        ...
        score = 0;
        Highscore = 0; // Highscore, now named wallet, will be a continuously updated variable
        //scoreIsSaved = false;
        /*
        //getting preferences
    ...
    // Eftir a� MainMenuScreen kallar � GameScreen r�sist �essi a�fer�, update.
    @Override
    public void update(float deltaTime) {
        ...
        // Notf�rum okkur enum Gamestate sem vi� skilgreindum efst til �ess a� keyra mismunandi
        // update a�fer�ir vi� mismunandi a�st��ur leiksins
        if (state == GameState.Ready)
            updateReady(touchEvents); // � upphafi er �� kalla� � �etta
    ...
    private void updateReady(List<TouchEvent> touchEvents) {
    	...
    	// Ef �a� er einhversskonar snerting ger� � snertiskj�inn keyrum vi� leikinn h�r
    ...
    private void drawReadyUI() {
        ...
        ////////////////////////////////////////////////////////////////
        // H�rna h�fum vi� �ll GetReady elementin okkar, takka o.s.frv.
        ////////////////////////////////////////////////////////////////

        // Skalinn byrjar efst til vinstri � glugganum
        // �.e.a.s. hnitakerfi�. Skalinn er 480 x 800 � S2
    ...
    // �etta teiknar hvern hlut � �v� standi sem hann er �
    ...
    public void paint(float deltaTime) {
        ...
        // �ar sem �a� er fyrst kalla� � paint() teiknum vi� �ll grunnelement h�r
