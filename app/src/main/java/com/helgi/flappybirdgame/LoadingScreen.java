...
public class LoadingScreen extends Screen {
    ...
    public void update(float deltaTime) {
        ...
        Assets.flappyBirdLogo 	= g.newImage("MainMenuScreen/CoinFlappLogo.png", ImageFormat.ARGB4444);
        ...
        // deprecated: Assets.pipe  			= g.newImage("GameScreen/Pipe.png", ImageFormat.ARGB4444);
        Assets.pipeGreen  			= g.newImage("GameScreen/PipeGreen.png", ImageFormat.ARGB4444);
        Assets.pipeRed  			= g.newImage("GameScreen/PipeRed.png", ImageFormat.ARGB4444);
